...
use Creations\GoogleAPI\Models\Settings as Settings;
use Creations\GoogleAPI\Models\Log      as Log;
...
class Google extends Controller
{
  ...
  protected $publicActions = ['index'];
      ...
      public function index() {
          ...
          $client->setRedirectUri(Backend::url('creations/googleapi/google'));
          ...
          if(!isset($token_data['email'])) {
              ...
              Flash::error(trans('creations.googleapi::lang.errors.google.invalid_user'));
          ...
          foreach($settings as $setting) {
              if(Settings::get($setting) == '') {
                  throw new ValidationException([
                      'code' => Lang::get('creations.googleapi::lang.errors.google.generic') . Lang::get('creations.googleapi::lang.errors.google.'.$setting.'_blank')
                  ]);
              }
          }
      }
